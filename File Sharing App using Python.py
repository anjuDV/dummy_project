...
# Why Port 8010 ? TCP Port 8010 use a defined protocol to communicate depending on the application. 
# A protocol is a set of formalized rules that explains how data is communicated over a network. 
# This is secured and is not infected by Virus/Trojan.


# assigning the appropriate port value
PORT = 8010
# this finds the name of the computer user
os.environ['USERPROFILE']  #The code finds the name of the USERPROFILE through OS module. And changes the directory to access the files on the desktop.
